/*(function () {
    ...
    var DATA_URL = 'https://api.github.com/users/Dimagerasimenko/repos';
    var TIMEOUT = 1000;
    var STATUS_OK = 200;
    window.backend = {};
    ...
    var getData = function (onLoad, onError) {
        ...
        request.addEventListener('timeout', function () {
            timeout("запрос не успел выполниться за: " + request.timeout);
        });
        return request;
    };
        ...
        request.addEventListener('load', function () {
            ...
            switch (request.status) {
                ...
                case statusCode.success:
                    onLoad(request.response);
                    console.log(request.status + ' ' + request.statusText + ' цэ ответ');
                    break;
